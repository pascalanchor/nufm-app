import {
  ...
  export default function ContractorMenu({ modalVisible, setModal }) {
    ...
    const navToComm = () => {
      navigation.navigate("Contractor/Communication");
      setModal(false);
    };
    const navToIncident = () => {
      navigation.navigate("Contractor/Incident");
      setModal(false);
    };
    const navToSupport = () => {
      navigation.navigate("Contractor/Support");
      setModal(false);
    };
    const navToRisk = () => {
      navigation.navigate("Contractor/Risk");
      setModal(false);
    };
    const MenuItems = [
